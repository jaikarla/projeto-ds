        ...
        <form className="professional-form" onSubmit={onSubmit}>
          ...
          <label>
            ...
            {fieldErrors.registro && (
              <span className="field-error">{fieldErrors.registro}</span>
            )}
          </label>
          ...
          <div className="form-grid">
            <label>
              ...
              {fieldErrors.uf && (
                <span className="field-error">{fieldErrors.uf}</span>
              )}
            </label>
            ...
            <label>
              ...
              />
              {fieldErrors.cbo && (
                <span className="field-error">{fieldErrors.cbo}</span>
              )}
            </label>
          </div>
          ...
          <label>
            ...
            />
            {fieldErrors.cns && (
              <span className="field-error">{fieldErrors.cns}</span>
            )}
          </label>
